...
bot = telebot.TeleBot('7546147291:AAE4NcnABJXWF1YbJoGHsBO7IjDOAmANu0s')
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 600:
                response = "Error: Time interval must be less than 60000000000000."
            else:
...
Vip 🌟 :
-> Attack Time : 30000000000 (S)
> After Attack Limit : 1000000000 sec
-> Concurrents Attack : 5000000000000
